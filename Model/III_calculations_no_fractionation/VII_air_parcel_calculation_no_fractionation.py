...
# along its trajectory for the 'without fractionation' case
...
D = joblib.load('/home/riqo/air_parcel_files/air_parcel_calculation_no_fractionation_input')

R = joblib.load('/home/riqo/air_parcel_files/air_parcel_calculation_input')
        ...
        for b in range(0, len(ntra)):
            ...
            if P[-2,b] >= 0:
                ...
                if a == 0:
                    ...
                    R_H_air_start = ((np.mean(R['delta_H_snow_starting_delta'][264:432, lat_index_start, lon_index_start]) / 1000) + 1) * H_VSMOW / alpha_H
                    R_O_air_start = ((np.mean(R['delta_O_snow_starting_delta'][264:432, lat_index_start, lon_index_start]) / 1000) + 1) * O_VSMOW / alpha_O
...
f = open('/home/riqo/air_parcel_files/air_parcel_calculation_output_no_fractionation', "wb")
