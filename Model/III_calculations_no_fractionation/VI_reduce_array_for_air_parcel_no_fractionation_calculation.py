# This file was used to reduce the surface snow array produced in 'V_surface_snow_files_no_fractionation_merge.py'
# to only include time periods relevant for the air parcel analysis

# The output of this file was used as the input for 'VII_air_parcel_no_fractionation_calculation.py'
...
M = joblib.load('/home/riqo/surface_snow_files/surface_snow_isotopic_composition_no_fractionation_all')
...
file_save = 'air_parcel_calculation_no_fractionation_input'
